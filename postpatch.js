...
const embed = {
    ...
    "fields": [
      {
        "name": "Возвращает опыт за сообщения",
        "value": "**В этом обновлении мы вернули опыт за сообщения, и команда !stats снова работает. (Работа над опытом за общение в войс чате идет полным ходом.) ** \n***⚙️ Если что-то не работает, сообщите об этом автору поста.***"
      }
    ]
  };
